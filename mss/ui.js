    ...
    const renderFolderDropdown = (prefix = '') => {
        ...
        return `
            <div class="folder-dropdown">
                ...
                <div class="folder-dropdown-content" id="${prefix}folderDropdownContent" style="display: none; position: fixed; left: 0; top: 0; width: 100vw; height: 100vh; overflow-y: auto; background-color: #1f2937; z-index: 1000; box-shadow: 0 4px 6px rgba(0,0,0,0.3); padding-top: 120px; padding-left: 1rem; padding-right: 1rem; padding-bottom: 1rem;">
