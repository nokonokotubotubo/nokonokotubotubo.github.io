...
(function() {
    ...
    // フィルター状態永続化機能
    // ===========================================
// Minews PWA - UI・表示レイヤー（チェックボックス復活+改善版）
(function() {
    'use strict';
    ...
    window.setState = (newState) => {
        ...
        if (newState.viewMode !== undefined || 
            ...
            console.log('フィルター状態を保存:', filterState);
        }
        
        console.log('状態変更:', { old: oldState, new: window.state, changed: newState });
        window.render();
    };
    ...
    // 以下のrenderArticleCard、renderArticleList、renderSettingsModal、renderModal関数は前回と同じ
    ...
    // renderSettingsModal関数（前回と同じ - 省略）
