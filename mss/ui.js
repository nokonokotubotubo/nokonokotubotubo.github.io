    ...
    const renderFolderDropdown = (prefix = '') => {
        ...
        return `
            <div class="folder-dropdown">
                ...
                <div class="folder-dropdown-content" id="${prefix}folderDropdownContent" style="display: none; position: fixed; left: 0; top: 60px; width: 100vw; max-height: calc(100vh - 60px); overflow-y: auto; background-color: #1f2937; z-index: 1000; box-shadow: 0 4px 6px rgba(0,0,0,0.3); padding: 1rem;">
