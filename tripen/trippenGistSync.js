...
const TrippenGistSync = {
    ...
    loadState() {
        ...
        this.lastLocalHash = this.state.lastLocalHash || null;
    ...
    resetChanged() {
        ...
        const stableHash = this.lastLocalHash || this.state.lastLocalHash || this.lastDataHash || this.state.lastRemoteHash || null;
        this.lastLocalHash = stableHash;
        this.state.pendingChangeId = null;
        this.state.lastPendingHash = null;
        ...
        this.state.lastLocalHash = stableHash;
        this.persistState();
    },
    ...
    async manualWriteToCloud(remoteStateInput = null) {
        ...
        try {
            ...
            if (preparation.shouldSkip) {
                this.resetChanged();
                const stableHash = preparation.localHash ?? this.state.lastLocalHash ?? null;
                this.state.lastLocalHash = stableHash;
                this.lastLocalHash = stableHash;
                this.state.lastPendingHash = null;
                this.lastPendingHash = null;
